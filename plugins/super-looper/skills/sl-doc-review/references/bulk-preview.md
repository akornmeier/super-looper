...
Only when `ToolSearch` explicitly returns no match or the tool call errors fall back to presenting numbered options and waiting for the user's next reply.
