...
# marketplace cache layout `~/.claude/plugins/cache/<marketplace>/super-looper/<version>/skills/sl-update`,
...
# Match `.../plugins/cache/*/super-looper/<version>/skills/sl-update[/]?`
# Capture group 1 is the version segment.
version=$(printf '%s\n' "$skill_dir" | sed -nE 's|.*/plugins/cache/[^/]+/super-looper/([^/]+)/skills/sl-update/?$|\1|p')
