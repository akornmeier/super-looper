...
```bash
/sl-promote                                   # Derive what shipped from context, draft defaults
/sl-promote [free-form description]           # You describe what shipped
/sl-promote a tweet thread and a LinkedIn post   # Request specific channels
/sl-promote 3 tweet options for the new export feature
```
...
> User: `/sl-promote 3 tweet options for the new one-click CSV export`
...
> User: `/sl-promote draft a launch across X, LinkedIn, and email`
