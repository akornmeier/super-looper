...
> Diff-scoped browser QA of `<branch>` vs `main`. Generated by `/sl-dogfood-beta` on <YYYY-MM-DD>.
...
<Reusable lessons worth carrying forward — patterns, gotchas, product/UX insights. Feed substantial ones to `sl-compound`.>
