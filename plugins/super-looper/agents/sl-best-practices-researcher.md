---
name: sl-best-practices-researcher
...
1. **Discover Available Skills**:
   ...
   - Check the project/workspace skill directory in `.claude/skills/**/SKILL.md`
   - Also check the user/home skill directory in `~/.claude/skills/**/SKILL.md`
...
2. **Identify Relevant Skills**:
   ...
   - Rails/Ruby → `sl-dhh-rails-style`
   - Frontend/Design → `sl-frontend-design`, `swiss-design`
   - TypeScript/React → `react-best-practices`
   - AI/Agents → `sl-agent-native-architecture`
   - Documentation → `sl-compound`
   - File operations → `rclone`, `sl-worktree`
