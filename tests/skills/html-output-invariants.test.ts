...
// byte-duplicated between sl-plan and sl-brainstorm (enforced by
...
describe("html-rendering.md reference content invariants", () => {
  ...
  test("DESIGN.md discovery paths in worktree-root order", () => {
    ...
    expect(/\.super-looper\/DESIGN\.md/.test(REFERENCE)).toBe(true)
  })
  ...
  test("section heading vocabulary matches section contract names", () => {
    // sl-work and sl-doc-review grep for section names (Implementation
