...
`sl-promote` drafts the copy at ship time, from ship context:
...
- You only need internal release notes — use `/sl-release-notes` for plugin release history
...
- [`sl-release-notes`](./sl-release-notes.md) — internal release history of the plugin (different audience: developers, not end users)
- [`sl-demo-reel`](./sl-demo-reel.md) — capture visual evidence of a shipped feature for a PR (pairs well as the visual to accompany announcement copy)
