#!/usr/bin/env python3
"""
list-plugin-releases.py — Fetch super-looper plugin releases from GitHub.
...
def attempt_anon(limit, api_base):
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "sl-release-notes-skill",
        },
    )
    try:
...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch super-looper plugin releases from GitHub."
    )
    parser.add_argument(
        "--limit",
        type=int,
