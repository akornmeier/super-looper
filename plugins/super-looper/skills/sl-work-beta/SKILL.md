---
name: sl-work-beta
description: "[BETA] Execute work efficiently while maintaining quality and finishing features. Beta channel for trialing sl-work changes before they land in stable."
...
**Beta rollout note:** Invoke `sl-work-beta` manually when you want to trial changes ahead of stable `sl-work`. During the beta period, planning and workflow handoffs remain pointed at stable `sl-work` to avoid dual-path orchestration complexity.
