...
- **Internal contradictions** or terminology drift -- sl-coherence-reviewer owns these
- **Technical feasibility** or architecture conflicts -- sl-feasibility-reviewer owns these
- **Scope-goal alignment** or priority dependency issues -- sl-scope-guardian-reviewer owns these
- **UI/UX quality** or user flow completeness -- sl-design-lens-reviewer owns these
