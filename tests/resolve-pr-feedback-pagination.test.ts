...
/**
 * The two GraphQL fetch scripts in sl-resolve-pr-feedback must paginate.
 *
...
const SCRIPTS_DIR = path.join(
  process.cwd(),
  "plugins/super-looper/skills/sl-resolve-pr-feedback/scripts",
)
...
describe("sl-resolve-pr-feedback scripts paginate GraphQL connections (issue #798)", () => {
