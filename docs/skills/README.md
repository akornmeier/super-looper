...
| [`sl-run`](./sl-run.md) | Execute or resume a canonical sl-plan Markdown artifact through dependency-ordered phases with one worker at a time, durable atomic run state, independent phase verification, goal-drift protection, and honest terminal status |
