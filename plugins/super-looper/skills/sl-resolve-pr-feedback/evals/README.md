...
- **Pressure as fact, not as editorial.** Eval 6 still supplies what would tempt a bad stop — three rounds spent, the finding sitting on code the agent's own last round added — but states it flatly and leaves the rationalization unwritten.
