---
name: sl-riffrec-feedback-analysis
...
- **Extensive analysis** — input is a longer recording, contains multiple issues / requirements / workflow walkthroughs, or the user wants requirements or brainstorm material. Read `references/extensive-analysis.md`. Always continue into the `sl-brainstorm` skill.
...
The Super Looper output format used by the extensive path is documented in `references/super-looper-feedback-format.md`.
