...
- **Suggested next step** — single sentence: file an issue, open `sl-debug`, or escalate to extensive analysis if more issues surfaced.
...
- No automatic handoff to `sl-brainstorm`. The quick path ends with the bug report.
