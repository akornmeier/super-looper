...
const BODY = readFileSync(
  path.join(
    process.cwd(),
    "plugins/super-looper/skills/sl-brainstorm/references/brainstorm-sections.md",
  ),
  "utf8",
)
...
describe("sl-brainstorm Key Decisions placement", () => {
...
// Mirror of the plan-sections.md metadata test on the sl-plan side
...
describe("sl-brainstorm metadata field contract", () => {
  ...
  test("brainstorm-sections.md states brainstorms carry no status field", () => {
    ...
    // lifecycle was removed (sl-work no longer mutates plans; completion is
